...
echo "</head>";
echo "<body>";
echo "    <h1>🎉 DSSM WhatsApp EcoCash Subscription System</h1>";
echo "    <div class='status success'>✅ System Status: ACTIVE</div>";
echo "    <div class='status info'>📱 WhatsApp Webhook: Verified & Running</div>";
echo "";
...
echo "        <p>🚀 Deployed on Render.com | Built with PHP 8.1 & Docker</p>";
echo "    </footer>";
echo "</body>";
echo "</html>";
?>